...
class Weixinpay {
    ...
    private $config=array(
        ...
        'APPSECRET'          => '3883fddcdba1ace9e9d9d4a74275fd67',  //公众帐号secert
        'NOTIFY_URL'         => 'http://debo.shangtongyuntian.com/Appapi/Pay/wxnotify/', // 接收支付状态的连接  改成自己的域名
        );
    ...
    public function unifiedOrder($order){
        ...
        $result['sign']=$sign;
        $result['nonce_str']='debo.shangtongyuntian.com';
        return $result;
    }

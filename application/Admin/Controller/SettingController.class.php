...
class SettingController extends AdminbaseController{
	...
	function site_post(){
		if (IS_POST) {
            ...
            $_POST['options']['register_coins'] = empty($_POST['options']['register_coins'])?0:$_POST['options']['register_coins'];
            $_POST['options']['invite_register_coins'] = empty($_POST['options']['invite_register_coins'])?0:$_POST['options']['invite_register_coins'];

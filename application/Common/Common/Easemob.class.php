...
class Easemob{
	...
	//环信参数
	private $client_id='YXA6FnifoPv2Eeez40F5lt_yeg';
	private $client_secret='YXA6MYORpHamV8l9icv6xVby1IOfOt0';
	private $org_name='1112180118178994';
	private $app_name='debo';
	private $url;
//------------------------------------------------------用户体系	
		/**
	 * 初始化参数
	...
	*/
    ...
    /*
        添加群管理员
    */
    function addGroupManager($group_id,$usernames){
    ...
    /*
        移除群管理员
    */
    function removeGroupManager($group_id,$username){

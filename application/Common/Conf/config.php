...
$configs= array(
    ...
    //'SHOW_ERROR_MSG'        =>  true,    // 显示错误信息
		...
		'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Comment','Appapi'),
        ...
        'CRON_CONFIG' => array(
            'test' => array('Appapi/Cron/index', '5', ''), //路径(格式同R)、间隔秒（0为一直运行）、指定一个开始时间
        ),
        ...
        'APPID'              => 'wxc49702817b48864f', // 微信支付APPID
        'MCHID'              => '1489148252', // 微信支付MCHID 商户收款账号
        'KEY'                => 'dcqqlun6cLO5Ea636a6YO55ay5C7bcaT', // 微信支付KEY
        'APPSECRET'          => '3883fddcdba1ace9e9d9d4a74275fd67', // 公众帐号secert (公众号支付专用)
        'NOTIFY_URL'         => 'http://debo.shangtongyuntian.com/Appapi/Pay/wxnotify', // 接收支付状态的连接
        ),
        'DEFAULT_AVATAR'     => 'http://debo.shangtongyuntian.com/data/upload/chatroom/small_59c25f4ef10002.55030992.jpg',
);

...
class CopartnerController extends ApibaseController{
    ...
    /**
     *前端请求(用来做判断的，0提交版本，1正式上线)
     * */
    public function get_states(){
        $this->json(0,'获取成功',array('is_show'=>0));
    }

    /**
     *安卓前端请求(用来做判断的，0提交版本，1正式上线)
     * */
    public function android_states(){
        $this->json(0,'获取成功',array('is_show'=>0));
    }
    ...
    public function get_rate() {
        ...
        $data = array(
            'three_rate' => '三个月 | ' . round(($options['three_rate'] * 10000 / 100 /30),2) .'元/天/万币',
            'six_rate' => '六个月 | ' . round(($options['six_rate'] * 10000 / 100 /30) ,2) . '元/天/万币',
            'nine_rate' => '九个月 | ' . round(($options['nine_rate'] * 10000 / 100 /30),2) . '元/天/万币',
            'twelve_rate' => '十二个月 | '. round(($options['twelve_rate'] * 10000 / 100 /30),2) . '元/天/万币',
            'freedom' => '自由购买 | ' . round(($options['rate'] * 10000 / 100 /30),2) . '元/天/万币',
        );
        $this->json(0,'成功', $data);
    }
